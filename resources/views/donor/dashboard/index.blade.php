...
<style>
    ...
    #uppertable tbody, td, th, thead, tr {
        border: 0 solid;
        font-size: 10px ;
        padding: 0 !important;
    ...
    .displaypunjab .table td, .table th {
        font-size: 1rem;
    }
    .displaysindh .table td, .table th {
        font-size: 1rem;
    }
    .displaykpk .table td, .table th {
        font-size: 1rem;
    }
    .displaybal .table td, .table th {
        font-size: 1rem;
    }
    td , tr{
        text-align:right;
        ...
        .vard-footer button, input, optgroup, select, textarea {
...
<div class="animated fadeIn">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="box-title">Hi, There Donor </h4>
                </div>
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card-body">
                             <div class="col-md-12" id="wide">
                                    <div class="row">
                                            <div class="map-container col-md-9" id="mapContainer">
                                                ...
                                                <button class="btnkpk" id="kpkBtn"></button>
                                                <button class="btnbal" id="balochistanBtn"></button>
                                                <button class="btnsindh" id="sindhBtn"></button>
...
<script>
    ...
    <script>
        ...
        .then(response => {
            ...
            .then(data => {
                ...
                const totalSum = data.headNewWellSetupsCount + data.headHandPumpSetupsCount + data.headRepairWellSetupsCount;
    ...
    <script>
        ...
        tharButton.addEventListener('click', function(event) {
            ...
            document.querySelector('.map-background').style.backgroundImage = "url('/pic/tharparkar.png')";
    ...
    <script>
        ...
        regionSelect.addEventListener('change', function() {
            ...
            if (selectedOption.value === "Punjab") {
                ...
                document.querySelector('.map-background').style.backgroundImage = "url('/pic/kpk (1).jpg')";
                document.querySelector('.map-background').style.height="35rem";
                document.querySelector('.col-md-9').style.height="35rem";
                ...
                fetch(`/get-all-kpk-setup-count`)
                    ...
                    .catch(error => console.error('Error fetching setup counts for KPK:', error.message));
        ...
        fetch(`/get-total-counts-by-region`)
            ...
            .then(data => {
                ...
                Object.entries(data).forEach(([region, counts]) => {
                    ...
                    const repairWellElement = document.getElementById(`${region.toLowerCase()}RepairWellCount`);
