            ...
            <div class="card"> 
                <div class="card-body">
                    <div class="profile-table">
                        ...
                        <img src="{{url(Auth::guard('donor')->user()->image ?? '')}}" alt="Profile Picture" class="profile-image">
...
@include('donor.profile.editform')
@endsection
@section('bot')
...
<script>
    $(document).ready(function() {
        window.editForm = function(id) {
            ...
            $.ajax({
                url: '/donor/profile/' + id,
                type: 'GET',
                success: function(data) {
                    $('#edit_id').val(data.user.id);
                    $('#name').val(data.user.name);
                    $('#f_h_name').val(data.user.f_h_name);
