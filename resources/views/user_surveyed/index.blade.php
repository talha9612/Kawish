                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Action Buttons">
                                            <form method="POST" action="{{ url('/project/add', $data->id) }}">
                                                @csrf
                                            ...
                                            <form method="POST" action="{{ url('/surveyed-edit/'. $data->id) }}">
                                                @csrf
                                                <!-- Add input fields for the data to be updated -->
...
@include('user_surveyed.surveyedform')
